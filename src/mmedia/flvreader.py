...
def getFlvDimensions(filename):
    width = 320 #defaults if we don't succeed...
    height = 240 
...
"""
This class is a recipe from the Python Cookbook:
http://aspn.activestate.com/ASPN/Cookbook/Python/Recipe/457406
"""
