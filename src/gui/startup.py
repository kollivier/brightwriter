...
class StartupDialog(wx.Dialog):
	def __init__(self, parent):
		...
		wx.Dialog.__init__ (self, parent, -1, _("Welcome to BrightWriter"),wx.DefaultPosition, wx.Size(460,160), wx.DEFAULT_DIALOG_STYLE)
		height = 20
		buttonstart = 90
		fontsize = 22
		...
		self.lblWelcome = wx.StaticText(self, -1, _("Welcome to BrightWriter"))
