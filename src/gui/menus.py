...
def getFileMenu():
    ...
    PubMenu = wx.Menu()
    PubMenu.Append(ID_PUBLISH, _("To web site"), _("Publish to a web server"))
    PubMenu.Append(ID_PUBLISH_CD, _("To CD-ROM"), _("Publish to a CD-ROM"))
    PubMenu.Append(ID_PUBLISH_KOLIBRI_STUDIO, _("To Kolibri"))
    ...
    FileMenu.Append(ID_PUBLISH_MENU, "&" + _("Publish"), PubMenu, "")
