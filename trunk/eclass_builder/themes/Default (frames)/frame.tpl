...
var index3 = "<!-- INSERT INDEX PAGE HERE -->";
...
if (self.name == 'menu') {
	...
	initialise();
	var thePage = pageFromSearch("<!-- INSERT INDEX PAGE HERE -->", theMenu, true);
	pageURL = this.location.href;
	var argsindex = pageURL.indexOf('?');
	args = pageURL.substring(argsindex + 1);
	if (argsindex > 0)
	{
