...
tag_attrs = {
    "A" :   { "required": [],
              "optional": ["href", "target", "name"]
            },
    "IMG" : { "required": ["src", "alt"], 
...
attr_values = {
    ...
    "TABLE":    { "align": table_halign },
    "TD":    { "align": table_halign, "valign": table_valign },
    "TR":    { "align": table_halign, "valign": table_valign },
    "UL":   { "type": { 
                _("Default"): "", 
                _("Circle"): "circle", 
                _("Disc"): "disc", 
